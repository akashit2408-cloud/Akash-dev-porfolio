      ...
      <section id="about" className="bg-luxury-card pt-20 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans border-b border-luxury-gold/10">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start relative z-10">
          ...
          <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-luxury-ivory mt-8 md:mt-0 relative z-20 aos-init">
            ...
            <div className="grid grid-cols-4 md:grid-cols-6 gap-3 md:gap-4 mt-10 w-fit">
              <img alt="React" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/React.jpg" />
              <img alt="Next.js" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Nestjs.jpg" />
              <img alt="PHP" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/php.jpg" />
              <img alt="MySQL" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/MySql.jpg" />
              <img alt="Tailwind CSS" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Tailwind.jpg" />
              <img alt="TypeScript" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Typescript.jpg" />
              <img alt="HTML5" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Html.jpg" />
              <img alt="CSS3" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/css.jpg" />
              <img alt="JavaScript" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/js.jpg" />
              <img alt="Java" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/java.jpg" />
              <img alt="GitHub" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Github.jpg" />
              <img alt="Git" className="w-12 h-12 md:w-14 md:h-14 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/git-K6RyaU-h.png" />
            </div>
          </div>
        </div>
