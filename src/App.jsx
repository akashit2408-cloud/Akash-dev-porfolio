        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start relative z-10">
          ...
          <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-luxury-ivory mt-8 md:mt-0 relative z-20 aos-init">
            ...
            <div className="grid grid-cols-4 md:grid-cols-6 gap-4 md:gap-6 mt-10">
              <img alt="React" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/React.jpg" />
              <img alt="Next.js" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Nestjs.jpg" />
              <img alt="PHP" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/php.jpg" />
              <img alt="MySQL" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/MySql.jpg" />
              <img alt="Tailwind CSS" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Tailwind.jpg" />
              <img alt="TypeScript" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Typescript.jpg" />
              <img alt="HTML5" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Html.jpg" />
              <img alt="CSS3" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/css.jpg" />
              <img alt="JavaScript" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/js.jpg" />
              <img alt="Java" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/java.jpg" />
              <img alt="GitHub" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/Github.jpg" />
              <img alt="Git" className="w-16 h-16 md:w-20 md:h-20 object-contain hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] bg-white rounded-xl p-1" src="./assets/git-K6RyaU-h.png" />
            </div>
          </div>
        </div>
